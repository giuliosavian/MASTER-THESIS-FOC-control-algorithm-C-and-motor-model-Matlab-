...
/* Coppie di poli motore */
#define MOTOR2_POLE_COUPLES				5		/* = 10 poli */
/* Riduzione motoriduttore */
//#define MOTOR2_REDUCTION_RATIO			50		/* 1:50 */
/* Velocit� Massime Possibili */
#define MOTOR2_MIN_RPM					200
#define MOTOR2_MAX_RPM					2000


/*
 * Motor Macros
 */
#define MOTOR_POLE_COUPLES					(MOTOR2_POLE_COUPLES)
...
#define MOTOR_MIN_SPEED_RPM					(MOTOR2_MIN_RPM)
#define MOTOR_MAX_SPEED_RPM					MOTOR_ADJUST_SPEED(MOTOR2_MAX_RPM)
