...
#define MIN_APPLICATION_SPEED_RPM       0 /*!< rpm, mechanical,
                                                           absolute value */
#define MEAS_ERRORS_BEFORE_FAULTS       30 /*!< Number of speed
                                                             measurement errors before
                                                             main sensor goes in fault */
/****** Hall sensors ************/
#define HALL_MEAS_ERRORS_BEFORE_FAULTS  30 /*!< Number of failed
...
//a vuoto Kp = 128 e Ki =128
//a vuoto with ats Kp = 32 e Ki = 64
//simulation Kp = 0.1751 Ki = 0.0194 or 0.0194*16000 so Kp =128 and Ki =256 (not good)
/* Gains values for torque and flux control loops */

//good gains are p = 64 and i =32 o 8
#define PID_TORQUE_KP_DEFAULT         128
#define PID_TORQUE_KI_DEFAULT         32
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           128
