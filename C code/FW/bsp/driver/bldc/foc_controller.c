...
static int16_t g_dbgfoc_Idref;
static int16_t g_dbgfoc_Id;
static int16_t g_dbgfoc_Vd;
static int16_t g_dbgfoc_Valpha;
static int16_t g_dbgfoc_Vbeta;
static int16_t g_dbgfoc_speed;
...
uint8_t FOC_Task(void)
{
	...
	int16_t hElAngle = SPEEDPOS_GetElAngle();
//	int32_t tq;
...
//	int32_t *out_bufId = &(pwmcHandle[M1]->LPFIdBuf);
	...
	/* Filtro */
//	tq = 2; //pwmcHandle[M1]->LPFIqd_const;
//	*out_bufIq = (*out_bufIq) + ((Iab.a - ((*out_bufIq) >> 15)) * tq);
//	idq_ave.q = (*out_bufIq) >> 15;
//	*out_bufId = (*out_bufId) + ((Iab.b - ((*out_bufId) >> 15)) * tq);
...
//		Wel_mecSpeedUnit *= -1;
//	int32_t W_rads = (SPEEDUNIT2RADS(Wel_mecSpeedUnit));
//	int32_t Id_mA = CURRENT_CONV_FACTOR_INV*Iqd.d;
//	int32_t Iq_mA = CURRENT_CONV_FACTOR_INV*Iqd.q;
//	float FluxLinkagePM = 0.00977;

	/*Decoupling*/
//	Vdecoupled.q = Vqd.q;
//	Vdecoupled.d = Vqd.d;
//	Vdecoupled.q += (int16_t)((FluxLinkagePM*W_rads*5) + Id_mA*LS*W_rads*5);
//	Vdecoupled.d -= (int16_t)(Iq_mA*LS*W_rads*5);

//	Vqd.q = 2000;
//	Vqd.d = 0;
	Vqd = Circle_Limitation(pCLM[M1], Vqd);
	Valphabeta = MCM_Rev_Park(Vqd, hElAngle);
//	Valphabeta.alpha = 1000;
//	Valphabeta.beta = 0;
...
//	FOCVars[M1].hFlux = FluxLinkagePM;
	...
	g_dbgfoc_Iq = Iqd.q;
	g_dbgfoc_Vq = Vqd.q;
	g_dbgfoc_Idref = FOCVars[M1].Iqdref.d;
	g_dbgfoc_Id = Iqd.d;
	g_dbgfoc_Vd = Vqd.d;
	g_dbgfoc_Valpha = Valphabeta.alpha;
	g_dbgfoc_Vbeta = Valphabeta.beta;
	g_dbgfoc_speed = SPEEDPOS_GetSpeedRpm();
